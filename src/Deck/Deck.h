...
//Creating the deck
  ...
  std::vector<Cards> Hand;
      ...
      //Maps for the enums
      //8 ForestCards Move 3 Armies, Add 3 Armies, Move 6 Armies*, Destroy 1 Army or Build City, Add 2 Armies or Move 3 Armies, Move 4 Armies via Ship, Build City, Move 3 Armies Via Ship
